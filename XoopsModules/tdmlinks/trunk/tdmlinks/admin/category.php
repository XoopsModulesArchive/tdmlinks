    ...
    case "list":
        ...
        if (count($links_cat)>0) {
            ...
            foreach (array_keys($category_ArrayTree) as $i) {
                ...
                echo '<td align="center">';
                echo '<a href="category.php?op=edit_cat&linkscat_cid=' . $i . '"><img src="../images/icon/edit.png" alt="'._AM_TDMLINKS_FORMEDIT.'" title="'._AM_TDMLINKS_FORMEDIT.'"></a> ';
                echo '<a href="category.php?op=del_cat&linkscat_cid=' . $i . '"><img src="../images/icon/delete.png" alt="'._AM_TDMLINKS_FORMDEL.'" title="'._AM_TDMLINKS_FORMDEL.'"></a>';
                echo '</td>';
                echo '</tr>';
