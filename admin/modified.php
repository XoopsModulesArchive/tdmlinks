    ...
    case "list":
        ...
        if ($numrows > 0) {
            ...
            foreach (array_keys($linksmod_arr) as $i) {
                ...
                echo '<a href="modified.php?op=view_links&links_lid=' . $links_lid . '&mod_id=' . $links_requestid . '"><img src="../assets/images/icon/view_mini.png" alt="' . _AM_TDMLINKS_FORMDISPLAY . '" title="' . _AM_TDMLINKS_FORMDISPLAY . '"></a> ';
                echo '<a href="modified.php?op=del_modlinks&mod_id=' . $links_requestid . '&new_file=' . $new_file . '"><img src="../assets/images/icon/ignore_mini.png" alt="' . _AM_TDMLINKS_FORMIGNORE . '" title="' . _AM_TDMLINKS_FORMIGNORE . '"></a>';
                echo '</td>';
            }
            echo '</table><br />';
