...
$xoopsOption['template_main'] = 'tdmlinks_modlink.tpl';
...
switch ($op) {
    ...
    case "list":
        ...
        $navigation .= ' <img src="assets/images/deco/arrow.gif" alt="arrow" /> ' . _MD_TDMLINKS_SINGLELINK_MODIFY;
    ...
    case "save":
        ...
        if ($erreur == true) {
            ...
            if ($linksmod_Handler->insert($obj)) {
                ...
                redirect_header('singlelink.php?lid=' . (int)($_REQUEST['lid']), 1, _MD_TDMLINKS_MODLINK_THANKSFORINFO);
            }
