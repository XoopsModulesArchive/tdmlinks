    ...
    case "list":
        ...
        if ($numrows > 0) {
            ...
            foreach (array_keys($linksbroken_arr) as $i) {
                ...
                echo '<a href="../visit.php?cid=' . $links_cid . '&lid=' . $links_lid . '" target="_blank"><img src="../assets/images/icon/link.png" alt="link ' . $links_title . '" title="link ' . $links_title . '"></a>';
                echo '</td>';
                echo '<td align="center">' . $links_title . '</td>';
                echo '<td align="center"><b>' . $links_poster . '</b> (' . $links_poster_ip . ')</td>';
                echo '<td align="center" width="15%">';
                echo '<a href="links.php?op=view_links&links_lid=' . $links_lid . '"><img src="../assets/images/icon/view_mini.png" alt="' . _AM_TDMLINKS_FORMDISPLAY . '" title="' . _AM_TDMLINKS_FORMDISPLAY . '"></a> ';
                echo '<a href="links.php?op=edit_links&links_lid=' . $links_lid . '"><img src="../assets/images/icon/edit.png" alt="' . _AM_TDMLINKS_FORMEDIT . '" title="' . _AM_TDMLINKS_FORMEDIT . '"></a> ';
                echo '<a href="broken.php?op=del_brokenlinks&broken_id=' . $links_reportid . '"><img src="../assets/images/icon/ignore_mini.png" alt="' . _AM_TDMLINKS_FORMIGNORE . '" title="' . _AM_TDMLINKS_FORMIGNORE . '"></a>';
                echo '</td>';
            }
            echo '</table><br />';
