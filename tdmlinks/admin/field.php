...
switch ($op) {
    ...
    case "list":
        ...
        if ($numrows > 0) {
            ...
            foreach (array_keys($links_field) as $i) {
                ...
                echo '<td align="center" width="10%"><a href="field.php?op=update_status&fid=' . $linksfield_fid . '&aff=' . ($links_field[$i]->getVar('status') === 1 ? '0"><img src="../assets/images/icon/on.png"></a>' : '1"><img src="../assets/images/icon/off.png"></a>') . '</td>';
                echo '<td align="center" width="10%"><a href="field.php?op=update_search&fid=' . $linksfield_fid . '&aff=' . ($links_field[$i]->getVar('search') === 1 ? '0"><img src="../assets/images/icon/on.png"></a>' : '1"><img src="../assets/images/icon/off.png"></a>') . '</td>';
                echo '<td align="center" width="10%">';
                echo '<a href="field.php?op=edit_field&fid=' . $linksfield_fid . '"><img src="../assets/images/icon/edit.png" alt="' . _AM_TDMLINKS_FORMEDIT . '" title="' . _AM_TDMLINKS_FORMEDIT . '"></a> ';
                if ($links_field[$i]->getVar('status_def') === 0) {
                    echo '<a href="field.php?op=del_field&fid=' . $linksfield_fid . '"><img src="../assets/images/icon/delete.png" alt="' . _AM_TDMLINKS_FORMDEL . '" title="' . _AM_TDMLINKS_FORMDEL . '"></a>';
                }
                echo '</td>';
                echo '</tr>';
    ...
    case "save_field":
        ...
        if ((int)($_REQUEST['weight']) === 0 && $_REQUEST['weight'] !== '0') {
            $erreur         = true;
