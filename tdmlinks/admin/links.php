...
switch ($op)
{
    ...
    case "list":
        ...
        if ($numrows>0) {
            ...
            foreach (array_keys($links_arr) as $i) {
                ...
                $category = TDMLinks_PathTree($mytree, $links_arr[$i]->getVar('cid'), $category_arr, 'cat_title', $prefix = ' <img src="../images/deco/arrow.gif"> ' );
                 echo '<tr class="'.$class.'">';
                echo '<td align="center">';
                echo '<a href="../visit.php?cid=' . $links_arr[$i]->getVar('cid') . '&lid=' . $i . '" target="_blank"><img src="../images/icon/link.png" alt="link ' . $links_arr[$i]->getVar('title') . '" title="link ' . $links_arr[$i]->getVar('title') . '"></a>';
                echo '</td>';
                ...
                echo '<td align="center">';
                echo ($statut_display == 1 ? '<a href="links.php?op=lock_status&links_lid=' . $i . '"><img src="./../images/icon/on.png" border="0" alt="' . _AM_TDMLINKS_FORMLOCK . '" title="' . _AM_TDMLINKS_FORMLOCK . '"></a> ' : '<a href="links.php?op=update_status&links_lid=' . $i . '"><img src="./../images/icon/off.png" border="0" alt="' . _AM_TDMLINKS_FORMVALID . '" title="' . _AM_TDMLINKS_FORMVALID . '"></a> ');
                echo '<a href="links.php?op=view_links&links_lid=' . $i . '"><img src="../images/icon/view_mini.png" alt="' . _AM_TDMLINKS_FORMDISPLAY.'" title="' . _AM_TDMLINKS_FORMDISPLAY . '"></a> ';
                echo '<a href="links.php?op=edit_links&links_lid=' . $i . '"><img src="../images/icon/edit.png" alt="' . _AM_TDMLINKS_FORMEDIT.'" title="' . _AM_TDMLINKS_FORMEDIT . '"></a> ';
                echo '<a href="links.php?op=del_links&links_lid=' . $i . '"><img src="../images/icon/delete.png" alt="' . _AM_TDMLINKS_FORMDEL.'" title="' . _AM_TDMLINKS_FORMDEL . '"></a>';
                echo '</td>';
             }
             echo '</table><br />';
    ...
    case "del_links":
        ...
        if (isset($_REQUEST['ok']) && $_REQUEST['ok'] == 1) {
            ...
            xoops_confirm(array('ok' => 1, 'links_lid' => $links_lid, 'op' => 'del_links'), $_SERVER['REQUEST_URI'], sprintf(_AM_TDMLINKS_FORMSUREDEL, $obj->getVar('title')) . '<br><br>' . _AM_TDMLINKS_FORMWITHFILE . ' <b><a href="' . $obj->getVar('url') . '">' . $obj->getVar('url') . '</a></b><br>');
        }
    break;
    ...
    case "view_links":
        ...
        $category = TDMLinks_PathTree($mytree, $view_links->getVar('cid'), $category_arr, 'cat_title', $prefix = ' <img src="../images/deco/arrow.gif"> ' );
        ...
        echo '<td><a href="../visit.php?cid=' . $view_links->getVar('cid') . '&lid=' . $links_lid . '"><img src="../images/icon/link.png" alt="link ' . $links_title . '" title="link ' . $links_title . '"></a></td>';
        echo '</tr>';
        echo '<tr class="odd">';
        ...
        echo '<td>' . $view_links->getVar('comments') . ' <a href="../singlefile.php?cid=' . $view_links->getVar('cid') . '&lid=' . $links_lid . '"><img src="../images/icon/view_mini.png" alt="' . _AM_TDMLINKS_FORMDISPLAY . '" title="' . _AM_TDMLINKS_FORMDISPLAY . '"></a></td>';
        echo '</tr>';
        $class = ($class == 'even') ? 'odd' : 'even';
        echo '<tr class="' . $class . '">';
        echo '<td width="30%">' . _AM_TDMLINKS_FORMACTION . ' </td>';
        echo '<td>';
        echo ($view_links->getVar('status') != 0 ? '' : '<a href="links.php?op=update_status&links_lid=' . $links_lid . '"><img src="./../images/icon/off.png" border="0" alt="' . _AM_TDMLINKS_FORMVALID . '" title="' . _AM_TDMLINKS_FORMVALID . '"></a> ');
        echo '<a href="links.php?op=edit_links&links_lid=' . $links_lid . '"><img src="../images/icon/edit.png" alt="' . _AM_TDMLINKS_FORMEDIT .
        '" title="' . _AM_TDMLINKS_FORMEDIT . '"></a> <a href="links.php?op=del_links&links_lid=' . $links_lid . '">
        <img src="../images/icon/delete.png" alt="' . _AM_TDMLINKS_FORMDEL . '" title="' . _AM_TDMLINKS_FORMDEL . '"></a></td>';
        echo '</tr>';
        echo '</table>';
        echo '<br>';
        // Affichage des votes:
        ...
        echo '</b><br /><br /></td></tr>';
        echo '<tr><td><b>' . _AM_TDMLINKS_LINKS_VOTE_USER . '</b></td>' . '<td><b>' . _AM_TDMLINKS_LINKS_VOTE_IP . '</b></td>' . '<td align="center"><b>' . _AM_TDMLINKS_FORMRATING . '</b></td>'
        . '<td><b>' . _AM_TDMLINKS_FORMDATE . '</b></td>' . '<td align="center"><b>' . _AM_TDMLINKS_FORMDEL . '</b></td></tr>';
        ...
        echo '</b><br /><br /></td></tr>';
        echo '<tr><td colspan="2"><b>' . _AM_TDMLINKS_LINKS_VOTE_IP . '</b></td>' . '<td align="center"><b>' . _AM_TDMLINKS_FORMRATING . '</b></td>'
        . '<td><b>' . _AM_TDMLINKS_FORMDATE . '</b></td>' . '<td align="center"><b>' . _AM_TDMLINKS_FORMDEL . '</b></td></tr>';
        foreach (array_keys($linksvotedata_arr) as $i) {
            echo '<tr>';
